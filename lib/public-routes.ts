export const PUBLIC_INDEXABLE_ROUTES = [
  ...
  { path: "/services/smart-home-installation", changeFrequency: "monthly", priority: 0.8 },
  { path: "/services/minor-plumbing-repairs", changeFrequency: "monthly", priority: 0.8 },
  { path: "/services/minor-electrical-repairs", changeFrequency: "monthly", priority: 0.8 },
  { path: "/services/kitchen-installation", changeFrequency: "monthly", priority: 0.8 },
  { path: "/services/bathroom-improvements", changeFrequency: "monthly", priority: 0.8 },
