...
export default async function InvoicePage({
  ...
  const {
    ...
    const pdfInvoice = mapInvoiceToPdf(invoice);

const pdfItems = mapInvoiceItemsToPdf(
  items ?? []
);
  ...
  return (
    ...
    <div className="mx-auto max-w-5xl space-y-8 p-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          className="rounded-lg border border-slate-300 bg-white px-5 py-2.5 font-medium transition hover:bg-slate-50"
        >
          Print
        </button>
