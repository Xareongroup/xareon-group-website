          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="mt-10 max-w-4xl">
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <TrackedEstimateLink href="/contact#estimate-form" placement="howard_county_hero" className="inline-flex min-h-12 items-center justify-center rounded-2xl bg-blue-600 px-7 py-3 font-semibold text-white transition hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Get a Free Estimate</TrackedEstimateLink>
