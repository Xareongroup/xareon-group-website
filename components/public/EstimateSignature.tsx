...
export default function EstimateSignature({ estimate }: { estimate: { signature_token: string | null } }) {
  ...
  async function approveEstimate() {
    ...
    try {
      ...
      setMessage("Estimate approved. Your signed PDF is available in the portal.");
    } catch (error) {
