...
type ContractSignatureProps = { contract: { signature_token: string | null }; portalToken?: string };

export default function ContractSignature({ contract, portalToken }: ContractSignatureProps) {
  ...
  async function signContract() {
    ...
    try {
      ...
      setCompleted(true); setMessage("Thank you! Your contract has been signed successfully.");
